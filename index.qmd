...
* Who locates where?
* What the global implications of those choices?
...
# Bus Operator Behaviour In Greater London
...
1. `git`
2. `julia`: immediate need to port a project from `v0.6` to `v1.9`
3. `R`: `{data.table}`, `{sf}`

. . .

Basically *everything* on learns in [ScPoProgramming](https://floswald.github.io/ScPoProgramming/) 😉
